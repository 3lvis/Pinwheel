...
public class DesignableViewController<View: UIView>: UIViewController, Containable {
    ...
    var childViewController: BaseDesignableViewController<View>?
    ...
    public override func viewDidLoad() {
        ...
        let viewController = BaseDesignableViewController<View>(
...
extension DesignableViewController: CornerAnchoringViewDelegate {
...
extension DesignableViewController: TweakingOptionsTableViewControllerDelegate {
