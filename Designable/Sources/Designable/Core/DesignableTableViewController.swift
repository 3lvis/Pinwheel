...
public class DesignableTableViewController: UITableViewController {
    ...
    private var sections: [DesignableSection]

    public init(sections: [DesignableSection]) {
...
public extension DesignableTableViewController {
...
extension DesignableTableViewController: BasicTableViewDelegate {
